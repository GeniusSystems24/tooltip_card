    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          indicatorColor: const Color(0xFF8B5CF6), // Violet 500
...
class _ChatTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final messages = [
      ...
      _Message(
        'Going great! Just finished the new feature.',
        'Sara',
        '10:32 AM',
        false,
        ['thumbsUp'],
      ...
      _Message(
        'Awesome work! Can you share a demo?',
        'Ahmed',
        '10:33 AM',
        true,
        [],
      ...
      _Message(
        'Sure, I will send a video shortly.',
        'Sara',
        '10:35 AM',
        false,
        [],
      ...
      _Message(
        'Also, the client meeting is at 2 PM today.',
        'Sara',
        '10:36 AM',
        false,
        ['calendar'],
      ),
      _Message('Thanks for the reminder!', 'Ahmed', '10:37 AM', true, [
        'heart',
      ]),
    ];
    ...
    return Center(
      child: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (ctx, i) =>
              _UserCard(user: users[i], publicState: publicState),
        ),
      ),
    );
  }
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [user.color, user.color.withValues(alpha: 0.5)],
              ),
  ...
  Widget build(BuildContext context) {
    final posts = [
      _Post(
        'Ahmed Hassan',
        '@ahmed_h',
        'Just launched our new product! Super excited to share this with everyone. Check it out!',
        '2h',
        234,
        56,
        12,
      ...
      _Post(
        'Sara Ali',
        '@sara_ali',
        'Design tip: Always test your UI with real content, not lorem ipsum. The difference is huge!',
        '4h',
        567,
        123,
        45,
      ...
      _Post(
        'Mohamed Nour',
        '@m_nour',
        'Building in public is the best way to learn. Share your progress, get feedback, and grow!',
        '6h',
        890,
        234,
        67,
    ...
    return Center(
      child: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (ctx, i) =>
              _PostCard(post: posts[i], publicState: publicState),
        ),
      ),
    );
  }
            ...
            Row(
              children: [
                TooltipCard.builder(
                  ...
                  builder: (ctx, close) => _MiniProfile(
                    name: post.name,
                    handle: post.handle,
                    color: post.color,
                  ),
...
class _NotificationsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final notifications = [
      ...
      _Notification(
        'Mohamed Nour started following you',
        '2m ago',
      ...
      _Notification(
        'Layla Ahmed commented on your photo',
        '15m ago',
        Icons.chat_rounded,
        Colors.green,
        'comment',
      ...
      _Notification(
        'Ahmed Hassan mentioned you in a story',
        '2h ago',
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: TooltipCard.builder(
        ...
        builder: (ctx, close) =>
            _NotificationActions(notification: notification, onClose: close),
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border(
              left: BorderSide(width: 3, color: notification.color),
              top: BorderSide(
                color: colorScheme.outline.withValues(alpha: 0.1),
              ),
              right: BorderSide(
